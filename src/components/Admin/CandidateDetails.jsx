    ...
    axios
      ...
      .then((value) => {
        ...
        if (status === "Approve") {
          console.log(status);
          emailjs
            .send("service_approve", "template_approve", emaildata)
            .then((result) => {
        ...
        if (status === "Reject") {
          console.log(status);
          emailjs
            .send("service_reject", "template_reject", emaildata)
            .then((result) => {
              console.log(result.text);
              window.location.reload();
            })
          ...
          <Grid className="status-card" xs={12} container spacing={2}>
            <Grid xs={12} sm={6}>
              <Card
                ...
                sx={{ height: 650, justifyContent: "center" }}
              >
                <CardContent>
                  <Typography
                  ...
                  >
                    ...
                    &nbsp;&nbsp;&nbsp; {candidate.name} ( {candidate.employStatus}{" "}
                    )
                  </Typography>
                  <Typography
                    variant="h6"
